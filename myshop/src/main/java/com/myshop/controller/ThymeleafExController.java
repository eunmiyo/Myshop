...
@RequestMapping(value="/thymeleaf") //request url경로지정, http://localhost/thymeleaf
public class ThymeleafExController {
	
	//http://localhost/thymeleaf/ex01
